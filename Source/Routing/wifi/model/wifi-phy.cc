...
{
  NS_LOG_DEBUG(" frame " << packet->GetUid() << " TX begin at " << Simulator::Now() << " size " << packet->GetSize() );
...
{
  NS_LOG_DEBUG("\t  " << packet->GetUid() << " TX end at " << Simulator::Now() << " size " << packet->GetSize() );
...
{
  NS_LOG_DEBUG("\t  " << packet->GetUid() << " TX drop at " << Simulator::Now() << " size " << packet->GetSize() );
...
{
  NS_LOG_DEBUG("\t RX frame " << packet->GetUid() << " begin at " << Simulator::Now() << " size " << packet->GetSize() );
...
{
  NS_LOG_DEBUG("\t RX frame " << packet->GetUid() << " ends at " << Simulator::Now() << " size " << packet->GetSize() );
