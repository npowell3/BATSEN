...
#define MAX_PKTS_PER_TRACE_FILE 100000000
...
private:
  ...
  AnimUidPacketInfoMap m_pendingEthernetPackets;
  ...
  void CsmaMacRxTrace (std::string context,
                       Ptr<const Packet> p);
  void EthernetPhyTxBeginTrace (std::string context,
                            Ptr<const Packet> p);
  void EthernetPhyTxEndTrace (std::string context,
                            Ptr<const Packet> p);
  void EthernetPhyRxEndTrace (std::string context,
                          Ptr<const Packet> p);
  void EthernetMacRxTrace (std::string context,
                       Ptr<const Packet> p);
  ...
  void OutputEthernetPacket (Ptr<const Packet> p, AnimPacketInfo& pktInfo);
