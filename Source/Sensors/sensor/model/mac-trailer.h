...
#ifndef SENSOR_MAC_TRAILER_H
#define SENSOR_MAC_TRAILER_H
...
namespace ns3 {
   ...
   */
  class MacFrameTrailer : public Trailer
  {
  public:
    /**
     * The length in octets of the IEEE 802.15.4 MAC FCS field
     */
    static const uint16_t FRAME_FCS_LENGTH;
