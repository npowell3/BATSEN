...
#ifndef SENSOR_CSMACA_H
#define SENSOR_CSMACA_H
 ...
 */
typedef Callback<void, SensorChnState> SensorMacStateCallback;

/**
 * \ingroup sensor
 *
 * This class is a helper for the SensorMac to manage the Csma/CA
 * state machine based on the IEEE 802.15.4-2006, section 7.5.1.4.
 */
class SensorCsmaCa : public Object
{
...
public:
   ...
   * Assessment, as part of the interconnections between the CSMA-CA and
   * the MAC. The callback lets MAC know a channel is either idle or busy.
   *
   * \param macState the mac state callback
   */
  void SetSensorMacStateCallback (SensorMacStateCallback macState);
...
private:
   ...
   */
  SensorCsmaCa (SensorCsmaCa const &);
  /**
   * \brief Copy constructor - defined and not implemented.
   * \returns
   */
  SensorCsmaCa& operator= (SensorCsmaCa const &);
   ...
   */
  SensorMacStateCallback m_sensorMacStateCallback;
